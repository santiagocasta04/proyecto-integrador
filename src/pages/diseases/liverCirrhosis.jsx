...
function LiverCirrhosisModel() {
  ...
  // Habilitar sombras en todas las geometrías y materiales
  scene.traverse((child) => {
    if (child.isMesh) {
      child.castShadow = true; // Permitir que proyecte sombras
      child.receiveShadow = true; // Permitir que reciba sombras
    }
  });
      ...
      <div className="modelo">
        ...
        <div className="model-viewer">
          <Canvas
            ...
            camera={{ position: [0, 0, 5] }} // Configuración de la cámara
